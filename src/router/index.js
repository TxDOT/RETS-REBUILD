...
const routes = [
    ...
    { path: `${import.meta.env.BASE_URL}map?retsid=:retsid`, props: true, name: "Map", component:()=> import('../views/mapContainer.vue')},
    { path: `${import.meta.env.BASE_URL}map`, name: "Maps", component:()=> import('../views/mapContainer.vue')},
